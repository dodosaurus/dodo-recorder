 ...
 * how to process Dodo Recorder session bundles for test generation.
 */

export const INSTRUCTIONS_TEMPLATE = `# Dodo Recorder - Session Bundle Instructions

## Overview
Dodo Recorder session bundles are framework-agnostic recordings of browser interactions with voice commentary. Each bundle contains all data needed to generate automated tests.
